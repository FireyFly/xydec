...
struct pokemon *decode_pokemon(struct pokemon_raw *data) {
  ...
  switch (shift_value) {
    ...
    case 0x03: perm = 0xADBC; break;
    case 0x04: perm = 0xACDB; break;
    case 0x05: perm = 0xADCB; break;
    case 0x06: perm = 0xBACD; break;
    case 0x07: perm = 0xBADC; break;
    case 0x08: perm = 0xCABD; break;
    case 0x09: perm = 0xDABC; break;
    case 0x0A: perm = 0xCADB; break;
    case 0x0B: perm = 0xDACB; break;
    case 0x0C: perm = 0xBCAD; break;
    case 0x0D: perm = 0xBDAC; break;
    case 0x0E: perm = 0xCBAD; break;
    case 0x0F: perm = 0xDBAC; break;
    case 0x10: perm = 0xCDAB; break;
    case 0x11: perm = 0xDCAB; break;
    case 0x12: perm = 0xBCDA; break;
    case 0x13: perm = 0xBDCA; break;
    case 0x14: perm = 0xCBDA; break;
    case 0x15: perm = 0xDBCA; break;
    case 0x16: perm = 0xCDBA; break;
